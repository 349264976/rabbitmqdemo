...
public class RabbitConfig {
    ...
    public Queue normalQueue(){
        ...
        arguments.put("x-message-ttl",20000); //设置对列的过期时间为20秒
        // 重点：：设置这两个参数
        arguments.put("x-dead-letter-exchange",exchangeDlxName); //设置对列的死信交换机
        arguments.put("x-dead-letter-routing-key","error"); //设置死信路由key，要和死信交换机和死信队列绑定key一模一样
